    ...
    <StaggeredSlideFade>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="grid gap-8 grid-cols-[repeat(auto-fill,_minmax(200px,_1fr))]">
            <div className="min-w-[6rem]">
              ...
              <p className="text-sm text-primary-900 dark:text-primary-300">Years of experience</p>
            </div>
            <div className="min-w-[6rem]">
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-8">
          ...
          <p>
            ie:{" "}
            <a href="https://www.youtube.com/watch?v=-w-P4u0x8ig" rel="noreferrer" target="_blank">
              Mock interview with Dan abramov
            </a>
            ,{" "}
            <a href="https://www.youtube.com/watch?v=SG5FFwLDuSQ" rel="noreferrer" target="_blank">
